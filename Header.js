...
const Header = () => {
    ...
    return ( <
        ...
        sx = {
            { background: 'linear-gradient(45deg, #0D0D0D, #333)', height: 64 }
        } >
        <
        Toolbar >
        <
        ...
        alt = 'logo'
        style = {
            { height: "2.5rem", borderRadius: '50%', marginRight: '0.5rem' }
        }
        /> < /
        Link > <
        Typography variant = "h6"
        sx = {
            { flexGrow: 1, color: '#f56d18', fontSize: '20px', fontWeight: 700, fontStyle: 'italic' }
        } >
        ...
        List > { /* Drawer menu items */ } {
            [
                ...
                StyledListItem button component = { Link }
                to = { path }
                onClick = { handleDrawerToggle }
                key = { text } > { icon } <
